...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "target_resource_id",
            "idempotency_key",
            name=op.f("uq_idempotency_records_action_type"),
        ),
    )
    op.create_table(
        "outbox_events",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "document_key", "version", name=op.f("uq_policy_documents_document_key")
        ),
    )
    op.create_table(
        "products",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product_id"], ["products.id"], name=op.f("fk_skus_product_id_products")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum(
                "CUSTOMER", "AGENT_OPERATOR", "SUPERVISOR", "ADMIN", name="role", native_enum=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["assigned_actor_id"],
            ["users.id"],
            name=op.f("fk_conversations_assigned_actor_id_users"),
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["conversation_id"],
            ["conversations.id"],
            name=op.f("fk_tickets_conversation_id_conversations"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["decided_by"], ["users.id"], name=op.f("fk_approval_requests_decided_by_users")
        ),
        sa.ForeignKeyConstraint(
            ["ticket_id"], ["tickets.id"], name=op.f("fk_approval_requests_ticket_id_tickets")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["ticket_id"], ["tickets.id"], name=op.f("fk_workflow_runs_ticket_id_tickets")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_run_id"],
            ["workflow_runs.id"],
            name=op.f("fk_retrieval_evidence_workflow_run_id_workflow_runs"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_run_id"],
            ["workflow_runs.id"],
            name=op.f("fk_tool_calls_workflow_run_id_workflow_runs"),
        ),
